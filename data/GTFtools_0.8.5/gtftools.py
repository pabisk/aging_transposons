...
def get_gene_bed(GTFfile,gene_bed_file='',chroms=list(map(str,range(1,23)))+['X','Y']):
	# get bed format
	genebed={}
	f = open(GTFfile)
	for line in f:
...
parser.add_argument('-g','--gene',metavar='gene',help="output file name for gene coordinates and names.")
...
parser.add_argument('-v','--version',action='version',version="GTFtools version:0.8.5")
